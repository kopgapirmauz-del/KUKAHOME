  ...
  getApp().innerHTML = `
    <section class="hero">
      <div class="hero-card reveal">
        <p class="eyebrow">Modern showroom experience</p>
        <h1 data-i18n="heroTitle">${t("heroTitle")}</h1>
        <p data-i18n="heroText">${t("heroText")}</p>
        <div class="pill-list">
          <span>Showroom mood</span>
          <span>Warm materiality</span>
        ...
        <div class="hero-note">
          <span>Interior consultants</span>
          <span>Toshkent, Samarqand, Namangan</span>
        </div>
      </div>
      <div class="hero-gallery reveal">
        <div class="glass-card showroom-stage"><div class="hero-visual"></div><div class="stage-copy"><strong>Flagship showroom mood</strong><span>Curated light, soft stone palette va premium flow.</span></div></div>
    ...
    ${section(
      "Showroom sahnasi kabi kolleksiya taqdimoti",
      "Har bir slayd mebelni katalog emas, real showroom kayfiyatida ko'rsatadigan iliq va aniq kompozitsiyada ishlaydi.",
    ...
    ${section(
      "Kolleksiyalar vitrinasi",
      "Mahsulot kartalari showroom vitrinasidek toza, keng va rasmlarga urg'u berilgan kompozitsiyada yangilandi.",
    ...
    ${section(
      ...
      "Mijoz avval makonni his qiladi, keyin model tanlaydi - shu flow asosida showroom va xizmat kartalari qurildi.",
