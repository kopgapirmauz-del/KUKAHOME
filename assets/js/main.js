(function () {
  ...
  var INLINE_TRANSLATIONS = {
    en: {
      ...
      furniture: { subtitle: 'Premium collections', collectionHeading: 'Choose furniture type', bedroom: 'Bedroom', kitchen: 'Kitchen', livingRoom: 'Living room', emptyType: 'No furniture in this category yet.', subcategories: { dressingTable: 'Dressing table', bed: 'Bed', mattress: 'Mattress', nightstand: 'Nightstand', wardrobe: 'Wardrobe', table: 'Table', chair: 'Chair', sofa: 'Sofa', armchair: 'Armchair', tvStand: 'TV stand', chest: 'Chest of drawers', coffeeTable: 'Coffee table' } },
    ...
    uz: {
      ...
      furniture: { subtitle: 'Premium kolleksiyalar', collectionHeading: 'Mebellar turini tanlang', bedroom: 'Yotoqxona', kitchen: 'Oshxona', livingRoom: 'Mehmonxona', emptyType: 'Bu bo\'limda hozircha mebel yo\'q.', subcategories: { dressingTable: 'Bezanish stoli', bed: 'Krovat', mattress: 'Matras', nightstand: 'Tumba', wardrobe: 'Garderob', table: 'Stol', chair: 'Stul', sofa: 'Divan', armchair: 'Kreslo', tvStand: 'TV tumba', chest: 'Komod', coffeeTable: 'Jurnal stoli' } },
      ...
      showrooms: { title: 'Manzil', subtitle: 'Premium ko‘rgazma zallarimizga tashrif buyuring', city: 'Shahar', address: 'Manzil', hours: 'Ish vaqti', map: 'Xaritada', cta: 'Tashrif buyuring', s1Name: 'Chilonzor fillial', s1Addr: 'Toshkent shahri, Chilonzor tumani, Gavhar ko\'chasi 124/1 (Olmazor metro)', s2Name: 'Yashnabod fillial', s2Addr: 'Toshkent shahri, Yashnabod tumani, Maxtimquli ko\'chasi, 75/4 (Arca 2-qavat)', s2Hours: '10:00 – 20:00', s3Name: 'Mirzo Ulug\'bek fillial', s3Addr: 'Toshkent shahri, Mirzo Ulug\'bek tumani, Temur Malik ko\'chasi 3A (Chimgan Atlas)', s3Hours: '10:00 – 20:00', s4Name: 'Almati Jibek Joli fillial', s4Addr: 'Qozog‘iston Res., Almati shahri, “Jibek Joli” savdo-ko‘ngilochar markazi (TRC), 2-qavat.', s5Name: 'Shimkent OTAU MART fillial', s5Addr: 'Qozog‘iston Res., Shimkent shahri, “OTAU MART” savdo-ko‘ngilochar markazi, 2-qavat.', s6Name: 'Almaty ARMADA fillial', s6Addr: 'Qozog‘iston Res., Almaty shahri, “ARMADA” savdo majmuasi, Kabdolov ko‘chasi, 1/8.' },
    ...
    ru: {
      ...
      home: { brandHeadline: 'Премиальная мебель №1 из Китая', brandSub: 'Современный дизайн, высокое качество, гарантия комфорта', newProducts: 'Новые продукты', allFurniture: 'Вся мебель', benefitsTitle: 'Преимущества', benefit1Title: 'Премиум качество', benefit1Desc: 'Лучшие материалы и безупречное исполнение.', benefit2Title: 'Быстрая доставка', benefit2Desc: 'Надёжная логистика и доставка в срок.', benefit3Title: 'Роскошный дизайн', benefit3Desc: 'Коллекции, которые подчёркивают статус интерьера.', benefit4Title: 'Гарантия комфорта', benefit4Desc: 'Мы отвечаем за комфорт и качество каждой модели.' },
      ...
      furniture: { subtitle: 'Премиальные коллекции', collectionHeading: 'Выберите тип мебели', bedroom: 'Спальня', kitchen: 'Кухня', livingRoom: 'Гостиная', emptyType: 'В этой категории пока нет мебели.', subcategories: { dressingTable: 'Туалетный столик', bed: 'Кровать', mattress: 'Матрас', nightstand: 'Тумба', wardrobe: 'Гардероб', table: 'Стол', chair: 'Стул', sofa: 'Диван', armchair: 'Кресло', tvStand: 'ТВ-тумба', chest: 'Комод', coffeeTable: 'Журнальный столик' } },
    ...
    zh: {
      ...
      home: { brandHeadline: '中国高端家具第一品牌', brandSub: '现代设计，高端品质，舒适保障', newProducts: '新品推荐', allFurniture: '全部家具', benefitsTitle: '优势', benefit1Title: '高端品质', benefit1Desc: '精选材料与精湛工艺，持久优雅。', benefit2Title: '快速配送', benefit2Desc: '高效物流，准时送达。', benefit3Title: '奢华设计', benefit3Desc: '提升空间格调的精选系列。', benefit4Title: '舒适保障', benefit4Desc: '每一件产品都兼顾舒适与品质。' },
      ...
      furniture: { subtitle: '高端系列', collectionHeading: '选择家具类型', bedroom: '卧室', kitchen: '厨房', livingRoom: '客厅', emptyType: '该分类暂无家具。', subcategories: { dressingTable: '梳妆台', bed: '床', mattress: '床垫', nightstand: '床头柜', wardrobe: '衣柜', table: '桌子', chair: '椅子', sofa: '沙发', armchair: '扶手椅', tvStand: '电视柜', chest: '抽屉柜', coffeeTable: '茶几' } },
      ...
      showrooms: { title: '我们的展厅', subtitle: '欢迎到访高端展示空间', city: '城市', address: '地址', hours: '营业时间', map: '地图', cta: '预约到访', s1Name: 'Chilonzor 分店', s1Addr: '塔什干市 Chilonzor 区 Gavhar 街 124/1（Olmazor 地铁）', s2Name: 'Yashnabod 分店', s2Addr: '塔什干市 Yashnabod 区 Maxtimquli 街 75/4 号（Arca 2 楼）', s2Hours: '10:00 – 20:00', s3Name: 'Mirzo Ulugbek 分店', s3Addr: '塔什干市 Mirzo Ulugbek 区 Temur Malik 街 3A（Chimgan Atlas）', s3Hours: '10:00 – 20:00', s4Name: '阿拉木图 Jibek Joli 分店', s4Addr: '哈萨克斯坦共和国，阿拉木图市，Jibek Joli 购物娱乐中心（TRC）二楼。', s5Name: '奇姆肯特 OTAU MART 分店', s5Addr: '哈萨克斯坦共和国，奇姆肯特市，OTAU MART 购物娱乐中心二楼。', s6Name: '阿拉木图 ARMADA 分店', s6Addr: '哈萨克斯坦共和国，阿拉木图市，ARMADA 商业综合体，Kabdolov 街 1/8。' },
    ...
    kz: {
      ...
      furniture: { subtitle: 'Премиум коллекциялар', collectionHeading: 'Жиһаз түрін таңдаңыз', bedroom: 'Жатын бөлме', kitchen: 'Ас үй', livingRoom: 'Қонақ бөлме', emptyType: 'Бұл бөлімде әзірше жиһаз жоқ.', subcategories: { dressingTable: 'Әрлеу үстелі', bed: 'Кереует', mattress: 'Матрас', nightstand: 'Тумба', wardrobe: 'Гардероб', table: 'Үстел', chair: 'Орындық', sofa: 'Диван', armchair: 'Кресло', tvStand: 'ТВ тумба', chest: 'Комод', coffeeTable: 'Журнал үстелі' } },
  ...
  function initHeroSlider() {
    ...
    slides.forEach(function (slide, idx) {
      ...
      if (!img) return;
      if (idx === 0 && img.loading === 'lazy') img.loading = 'eager';
      if (!img.complete) {
  ...
  var INLINE_PRODUCTS_MANIFEST = [
    { id: '1', folder: '1.BY.736B', model: 'BY.736B', type: 'Mehmonxona', type2: 'Divan', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/1.BY.736B/product-2.jpg', 'assets/images/products/mebel/1.BY.736B/product-21.jpg', 'assets/images/products/mebel/1.BY.736B/product-212.jpg'] },
    { id: '2', folder: '2.BY.700', model: 'BY.700', type: 'Mehmonxona', type2: 'Divan', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/2.BY.700/product-3.jpg', 'assets/images/products/mebel/2.BY.700/product-31.jpg', 'assets/images/products/mebel/2.BY.700/product-312.jpg'] },
    { id: '3', folder: '3.BY.776', model: 'BY.776', type: 'Mehmonxona', type2: 'Divan', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/3.BY.776/1.jpg', 'assets/images/products/mebel/3.BY.776/2.jpg', 'assets/images/products/mebel/3.BY.776/4.jpg'] },
    { id: '5', folder: '5.BY.820', model: 'BY.820', type: 'Mehmonxona', type2: 'Divan', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/5.BY.820/product-6.jpg', 'assets/images/products/mebel/5.BY.820/product-61.jpg', 'assets/images/products/mebel/5.BY.820/product-613.jpg'] },
    { id: '6', folder: '6.PT3106', model: 'PT3106', type: 'Yotoqxona', type2: 'Bezanish stoli', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/6.PT3106/1.jpg', 'assets/images/products/mebel/6.PT3106/2.jpg', 'assets/images/products/mebel/6.PT3106/3.jpg'] },
    { id: '7', folder: '7.PT3223TQ', model: 'PT3223', type: 'Yotoqxona', type2: 'Bezanish stoli', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/7.PT3223TQ/1.jpg', 'assets/images/products/mebel/7.PT3223TQ/2.jpg', 'assets/images/products/mebel/7.PT3223TQ/3.jpg'] },
    { id: 'Jurnalniy1', folder: 'Jurnalniy1', model: 'Model nomi', type: 'Mehmonxona', type2: 'Jurnalniy', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Jurnalniy1/1.jpg', 'assets/images/products/mebel/Jurnalniy1/2.jpg', 'assets/images/products/mebel/Jurnalniy1/3.jpg'] },
    { id: 'Kreslo1', folder: 'Kreslo1', model: 'Yumshoq kreslo', type: 'Mehmonxona', type2: 'Kreslo', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Kreslo1/1.jpg', 'assets/images/products/mebel/Kreslo1/2.jpg', 'assets/images/products/mebel/Kreslo1/3.jpg'] },
    { id: 'Kreslo2', folder: 'Kreslo2', model: 'Elektro mexanicheskiy kreslo', type: 'Mehmonxona', type2: 'Kreslo', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Kreslo2/1.jpg', 'assets/images/products/mebel/Kreslo2/2.jpg', 'assets/images/products/mebel/Kreslo2/3.jpg'] },
    { id: 'Kreslo3', folder: 'Kreslo3', model: 'Kreslo', type: 'Mehmonxona', type2: 'Kreslo', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Kreslo3/1.jpg', 'assets/images/products/mebel/Kreslo3/2.jpg', 'assets/images/products/mebel/Kreslo3/3.jpg'] },
    { id: 'Kreslo4', folder: 'Kreslo4', model: 'Yoga kreslo', type: 'Mehmonxona', type2: 'Kreslo', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Kreslo4/1.jpg', 'assets/images/products/mebel/Kreslo4/2.jpg', 'assets/images/products/mebel/Kreslo4/3.jpg', 'assets/images/products/mebel/Kreslo4/4.jpg', 'assets/images/products/mebel/Kreslo4/5.jpg'] },
    { id: 'Kreslo5', folder: 'Kreslo5', model: 'Yoga kreslo', type: 'Mehmonxona', type2: 'Kreslo', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Kreslo5/1.jpg', 'assets/images/products/mebel/Kreslo5/2.jpg'] },
    { id: 'Kreslo6', folder: 'Kreslo6', model: 'Yoga kreslo', type: 'Mehmonxona', type2: 'Kreslo', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Kreslo6/1.jpg', 'assets/images/products/mebel/Kreslo6/2.jpg'] },
    { id: 'Stul1', folder: 'Stul1', model: 'Stul', type: 'Oshxona', type2: 'Stul', info: { uz: 'Yangi modelimizni sizga tavfsiya qilamiz!', kz: 'Premium collection', ru: 'Premium collection', en: 'Premium collection', zh: 'Premium collection' }, images: ['assets/images/products/mebel/Stul1/1.jpg', 'assets/images/products/mebel/Stul1/2.jpg', 'assets/images/products/mebel/Stul1/3.jpg'] }
  ];

  function getCatalogProducts() {
    if (Array.isArray(window.KUKA_PRODUCTS_MANIFEST)) return window.KUKA_PRODUCTS_MANIFEST;
    return fetch(getRootPrefix() + 'assets/data/products-manifest.json?v=20260714f', { cache: 'no-cache' })
      .then(function (res) {
        if (!res.ok) throw new Error('Products manifest not found');
        return res.json();
      })
      .catch(function () { return INLINE_PRODUCTS_MANIFEST; });
  }

  function getProductNewLabel() {
    var lang = getStoredLang();
    var labels = {
      uz: 'Yangilik',
      kz: 'Жаңалық',
  ...
  function createCatalogCard(meta, images) {
      var dots = images.map(function (_, index) {
        return '<span' + (index === 0 ? ' class="active"' : '') + '></span>';
      }).join('');
      var badge = meta.isNew ? '<span class="product-new-badge">' + escapeHtml(getProductNewLabel()) + '</span>' : '';
      return '<article class="product-card reveal">'
      + '<div class="product-gallery" data-product-gallery data-images="' + images.map(absolutizeAssetPath).join('|') + '">'
      + '<img src="' + absolutizeAssetPath(images[0]) + '" alt="' + meta.title + '" loading="lazy" decoding="async" data-product-image>'
      + badge
  ...
  function initFurnitureGallery() {
    ...
    var paginationRoot = document.getElementById('products-pagination');
    var FURNITURE_PAGE_SIZE = 16;
    var titleMap = {
    ...
    function normalizeProductType(value) {
      return String(value || 'mehmonxona')
        .trim()
        .toLowerCase()
        .replace(/['‘’`]/g, '')
        .replace(/[_-]+/g, '')
    ...
    var furnitureSubcategories = {
      yotoqxona: [
        { value: 'Bezanish stoli', i18n: 'furniture.subcategories.dressingTable' },
        { value: 'Krovat', i18n: 'furniture.subcategories.bed' },
        { value: 'Matras', i18n: 'furniture.subcategories.mattress' },
        { value: 'Tumba', i18n: 'furniture.subcategories.nightstand' },
        { value: 'Garderob', i18n: 'furniture.subcategories.wardrobe' }
      ],
      oshxona: [
        { value: 'Stol', i18n: 'furniture.subcategories.table' },
        { value: 'Stul', i18n: 'furniture.subcategories.chair' }
      ],
      mehmonxona: [
        { value: 'Divan', i18n: 'furniture.subcategories.sofa' },
        { value: 'Kreslo', i18n: 'furniture.subcategories.armchair' },
        { value: 'TV tumba', i18n: 'furniture.subcategories.tvStand' },
        { value: 'Komod', i18n: 'furniture.subcategories.chest' },
        { value: 'Jurnalniy', i18n: 'furniture.subcategories.coffeeTable' }
      ]
    };

    function getLatestItems(items, limit) {
      return items.slice(-limit).reverse();
    }

    function getProductTimestamp(item) {
      var time = Date.parse(item && item.updatedAt ? item.updatedAt : '');
      return Number.isNaN(time) ? 0 : time;
    }

    function getLatestUploadedItems(items, limit) {
      return items.map(function (item, index) {
        return { item: item, index: index, time: getProductTimestamp(item) };
      }).sort(function (a, b) {
    ...
    function renderFurniturePagination(totalItems, currentPage, onPageChange) {
      if (!paginationRoot) return;
      var totalPages = Math.ceil(totalItems / FURNITURE_PAGE_SIZE);
      if (totalPages <= 1) {
      ...
      var labels = getPaginationLabels();
      var html = '<button type="button" class="products-page-arrow" data-page="' + (currentPage - 1) + '"' + (currentPage === 1 ? ' disabled' : '') + '>' + labels.prev + '</button>';
      html += buildPaginationItems(currentPage, totalPages).map(function (page) {
        if (page === 'dots') return '<span class="products-page-dots">...</span>';
        return '<button type="button" class="products-page-number' + (page === currentPage ? ' active' : '') + '" data-page="' + page + '" aria-label="Page ' + page + '">' + page + '</button>';
      }).join('');
      html += '<button type="button" class="products-page-arrow" data-page="' + (currentPage + 1) + '"' + (currentPage === totalPages ? ' disabled' : '') + '>' + labels.next + '</button>';

      paginationRoot.innerHTML = html;
      paginationRoot.classList.remove('hidden');
      paginationRoot.querySelectorAll('button[data-page]').forEach(function (button) {
    ...
    function renderHomeNewItems(items) {
      return getLatestUploadedItems(items.filter(function (item) { return item.isNew === true; }), 8).map(function (item, idx) {
        return createCatalogCard({
          title: item.model || ('Model ' + (idx + 1)),
          desc: getLocalizedInfo(item),
          isNew: item.isNew === true
    ...
    function renderFurnitureGrid(items, type, subtype, page, skipFinalize) {
      if (!grid) return;
      var empty = document.getElementById('products-empty');
      var source = Array.isArray(items) ? items : [];
      var selectedType = normalizeProductType(type);
      var selectedSubtype = normalizeProductType(subtype || '');
      var list = type
        ? source.filter(function (item) {
            var matchesType = normalizeProductType(item.type) === selectedType;
            var matchesSubtype = !subtype || normalizeProductType(item.type2) === selectedSubtype;
            return matchesType && matchesSubtype;
          })
        : source.slice();
      var currentPage = Math.max(1, Number(page) || 1);
      var totalPages = Math.max(1, Math.ceil(list.length / FURNITURE_PAGE_SIZE));
      currentPage = Math.min(currentPage, totalPages);
      var pageItems = list.slice((currentPage - 1) * FURNITURE_PAGE_SIZE, currentPage * FURNITURE_PAGE_SIZE);

      grid.classList.add('is-changing');
      grid.innerHTML = renderManifestItems(pageItems);
      requestAnimationFrame(function () {
        grid.classList.remove('is-changing');
      });
      renderFurniturePagination(list.length, currentPage, function (nextPage) {
        renderFurnitureGrid(items, type, subtype, nextPage);
        grid.scrollIntoView({ behavior: 'smooth', block: 'start' });
      });
      if (empty) empty.classList.toggle('hidden', list.length > 0);
      if (!skipFinalize) finalizeProducts();
    }

    function renderFurnitureSubcategories(items, type, activeSubtype) {
      var root = document.getElementById('furniture-subcategory-list');
      if (!root) return;
      var normalizedType = normalizeProductType(type);
      var normalizedActiveSubtype = normalizeProductType(activeSubtype || '');
      var labels = furnitureSubcategories[normalizedType] || [];
      if (!labels.length) {
      ...
      root.innerHTML = labels.map(function (item) {
        ...
        var isActive = normalizedActiveSubtype && normalizeProductType(item.value) === normalizedActiveSubtype;
        return '<button type="button" class="furniture-subcategory-chip' + (isActive ? ' active' : '') + '" data-subtype="' + escapeHtml(item.value) + '">' + escapeHtml(label) + '</button>';
      }).join('');
      root.classList.remove('hidden');
      root.querySelectorAll('[data-subtype]').forEach(function (button) {
        button.addEventListener('click', function () {
          var subtype = button.getAttribute('data-subtype') || '';
          root.setAttribute('data-active-subtype', subtype);
          root.querySelectorAll('[data-subtype]').forEach(function (btn) { btn.classList.toggle('active', btn === button); });
          renderFurnitureGrid(items, type, subtype, 1);
        });
      });
    }

    function bindFurnitureTypeFilters(items) {
      var buttons = document.querySelectorAll('.furniture-category-chip[data-type]');
      ...
      function resetFurnitureFilters() {
        ...
        var subcategoryRoot = document.getElementById('furniture-subcategory-list');
        if (subcategoryRoot) {
          subcategoryRoot.removeAttribute('data-active-subtype');
          subcategoryRoot.classList.add('hidden');
          subcategoryRoot.innerHTML = '';
        }
        renderFurnitureGrid(items, '', '', 1);
      }

      function rerenderActiveFilters() {
        if (!activeType) {
          renderFurnitureGrid(items, '', '', 1);
          return;
        }
        renderFurnitureSubcategories(items, activeType, activeSubtype);
        renderFurnitureGrid(items, activeType, activeSubtype, 1);
      }
      ...
      buttons.forEach(function (button) {
        ...
        button.addEventListener('click', function () {
          ...
          activeType = type;
          activeSubtype = '';
          buttons.forEach(function (btn) { btn.classList.toggle('active', btn === button); });
          renderFurnitureSubcategories(items, type);
          renderFurnitureGrid(items, type, '', 1);
        });
      });

      var subcategoryRoot = document.getElementById('furniture-subcategory-list');
      if (subcategoryRoot && subcategoryRoot.dataset.boundActiveSubtype !== 'true') {
        subcategoryRoot.dataset.boundActiveSubtype = 'true';
        subcategoryRoot.addEventListener('click', function (e) {
          var button = e.target.closest('[data-subtype]');
          if (!button || !subcategoryRoot.contains(button)) return;
          activeSubtype = button.getAttribute('data-subtype') || '';
        });
      }

      if (!bindFurnitureTypeFilters._langBound) {
        bindFurnitureTypeFilters._langBound = true;
        document.addEventListener('kuka:lang-changed', rerenderActiveFilters);
      }
    }
    ...
    if (grid || homeGrid) {
      Promise.resolve(getCatalogProducts())
        .then(function (items) {
          ...
          if (grid) {
            renderFurnitureGrid(items, '', '', 1, true);
            bindFurnitureTypeFilters(items);
          }
          if (homeGrid) homeGrid.innerHTML = renderHomeNewItems(items);
        })
        .catch(function () {
    ...
    var lightboxState = bindFurnitureGalleries._state || { activeImages: [], activeIndex: 0 };
    bindFurnitureGalleries._state = lightboxState;

    function showLightboxImage() {
      if (!lightboxImage || !lightboxState.activeImages.length) return;
      lightboxImage.src = lightboxState.activeImages[lightboxState.activeIndex];
    }

    function openLightbox(images, startIndex) {
      if (!lightbox || !lightboxImage) return;
      lightboxState.activeImages = images;
      lightboxState.activeIndex = startIndex || 0;
      showLightboxImage();
      lightbox.classList.add('open');
      lightbox.setAttribute('aria-hidden', 'false');
      document.body.style.overflow = 'hidden';
    ...
    function closeLightbox() {
      ...
      lightboxState.activeImages = [];
      lightboxState.activeIndex = 0;
    }

    function moveLightbox(step) {
      if (!lightboxState.activeImages.length) return;
      lightboxState.activeIndex = (lightboxState.activeIndex + step + lightboxState.activeImages.length) % lightboxState.activeImages.length;
      showLightboxImage();
    }
    ...
    galleries.forEach(function (gallery) {
      ...
      gallery._index = 0;
        ...
        function render(index) {
          ...
          if (image.src !== images[index]) image.src = images[index];
