(function () {
  ...
  function initMobileBottomNav() {
    ...
    var videosHref = isPages ? 'videos.html' : 'pages/videos.html';
    ...
    var items = [
      ...
      { key: 'videos', href: videosHref, i18n: 'nav.videos', fallback: 'Videolar', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="5" width="18" height="14" rx="3"/><path d="m10 9 5 3-5 3z" fill="currentColor" stroke="none"/></svg>' },
