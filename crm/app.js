...
function cacheRefs() {
  const ids = [
    ...
    "clientsPage", "settingsPage", "integrationsPage", "warehousePage", "salesPage", "searchInput", "statusFilter", "attendanceFilter", "storeFilter", "managerFilter", "clearFilters",
...
function restoreSession() {
  ...
  Promise.all([loadManagersAndShowrooms(), loadClients(), loadNotificationsFromApi()]).finally(() => refreshUI());
}
...
async function onClientSubmit(e) {
  ...
  if (state.editingClientId) {
    ...
    if (state.user.role === "manager" && !apiCreated) {
