...
function getPrimaryPagesByRole(role) {
  if (role === "admin") return ["clients", "integrations", "warehouse", "sales", "settings"];
  if (role === "manager") return ["clients", "warehouse", "sales", "priceLabel", "settings"];
  if (role === "hr") return ["clients", "hr", "priceLabel", "sales", "settings"];
  if (role === "cashier") return ["clients", "sales", "priceLabel", "hr", "settings"];
  if (role === "skladchi") return ["clients", "warehouse", "priceLabel", "sales", "settings"];
  return ["clients", "settings"];
}

function getAllowedPagesByRole(role) {
  const primary = getPrimaryPagesByRole(role);
  const all = ["clients", "integrations", "warehouse", "sales", "hr", "priceLabel", "settings"];
