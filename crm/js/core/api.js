...
function clientContactCellHtml(contact) {
  ...
  return `<span class="client-contact-wrap contact-single-line has-menu"><button class="client-contact-main-btn" type="button" data-contact-menu-toggle>${escapeHtml(parsed.phoneDisplay)}</button><span class="client-contact-menu">${menuItems}</span>${linkHtml}</span>`;
}
